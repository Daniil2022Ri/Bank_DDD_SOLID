...
class SuspiciousTransferMapperTest {
    ...
    void toCardEntity_WithValidDto_ShouldReturnEntity() {
        ...
        SuspiciousCardTransfer entity = mapperService.toCardEntity(dto);
    ...
    void toCardDto_WithValidEntity_ShouldReturnDto() {
        ...
        SuspiciousCardTransferDto dto = mapperService.toCardDto(entity);
    ...
    void toPhoneEntity_WithValidDto_ShouldReturnEntity() {
        ...
        SuspiciousPhoneTransfer entity = mapperService.toPhoneEntity(dto);
    ...
    void toPhoneDto_WithValidEntity_ShouldReturnDto() {
        ...
        SuspiciousPhoneTransferDto dto = mapperService.toPhoneDto(entity);
    ...
    void toAccountEntity_WithValidDto_ShouldReturnEntity() {
        ...
        SuspiciousAccountTransfer entity = mapperService.toAccountEntity(dto);
    ...
    void toAccountDto_WithValidEntity_ShouldReturnDto() {
        ...
        SuspiciousAccountTransferDto dto = mapperService.toAccountDto(entity);
